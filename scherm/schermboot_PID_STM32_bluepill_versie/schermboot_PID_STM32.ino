...
uint8_t          setDistance         = 71;               // target distance in cm that the PID will try to reache
...
int16_t          leftAcutatorStroke2 = 100;
int16_t          rightAcutatorStroke2 = 100;
...
void computePid()
{
  ...
  D = kd * diffErrorFilter / (pidTime - lastPidTime);

  P = constrain(P, -1300, 1300);
  I = constrain(I, -1300, 1300);
  D = constrain(D, -130, 130);
